...
class ApiMovilController extends FOSRestController
{
   ...
   */
   public function postAction(Request $request)
   {
    ...
    {
        $intIdRestaurante       = isset($arrayData['idRestaurante']) ? $arrayData['idRestaurante']:'';
        $intIdCliente           = isset($arrayData['idCliente']) ? $arrayData['idCliente']:'';
        $strTipoComida          = isset($arrayData['tipoComida']) ? $arrayData['tipoComida']:'';
        $strTipoIdentificacion  = isset($arrayData['tipoIdentificacion']) ? $arrayData['tipoIdentificacion']:'';
        $strIdentificacion      = isset($arrayData['identificacion']) ? $arrayData['identificacion']:'';
        $strRazonSocial         = isset($arrayData['razonSocial']) ? $arrayData['razonSocial']:'';
        ...
        $conImagen              = isset($arrayData['imagen']) ? $arrayData['imagen']:'NO';
        $conIcono               = isset($arrayData['icono'])  ? $arrayData['icono']:'NO';
        ...
        try
        {
            ...
            $arrayRestaurante   = (array) $this->getDoctrine()->getRepository(InfoRestaurante::class)->getRestauranteCriterioMovil($arrayParametros);
           error_log('.-.-.'.print_r($arrayRestaurante,1)); 
        ...
        $objParametro    = $this->getDoctrine()->getRepository(AdmiParametro::class)->findOneBy(array('ESTADO'      => 'ACTIVO',
